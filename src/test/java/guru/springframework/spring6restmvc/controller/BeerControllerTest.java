...
class BeerControllerTest {
    ...
    void getBeerByIdNotFound() throws Exception{
        ...
        given(beerService.getBeerById(testBeerId)).willThrow(NotFoundException.class);
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.saveNewBeer(any(Beer.class))).willReturn(beerServiceImpl.listBeers().get(0));
